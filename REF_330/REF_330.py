...
while url_index < len(url_list):
    try:
        ...
        if url_check == 0:
            ...
            ini_path = os.path.join(os.getcwd(), "REF_330.ini")
        ...
        date_time_meta=soup.find("section",id="issue_0").get_text(strip=True)
        pattern = r"(\w+)\s(\d{4})Vol:\s(\d+),\sIssue\s(\d+)"
        ...
        All_articles =soup.find_all("div",class_="right al-article-items")
        ...
        while article_index < len(All_articles):
            ...
            try:
                Article_link = "https://iovs.arvojournals.org" + All_articles[article_index].find("div", class_="customLink").find("a").get("href")
                Article_title = All_articles[article_index].find("div", class_="customLink").find("a").get_text(strip=True)
                DOI_element = All_articles[article_index].find("div", class_="al-cite-description").find("a")
                ...
                pdf_link = f"https://iovs.arvojournals.org{All_articles[article_index].find("a",class_="al-link pdf pdfaccess").get("data-article-url")}"
