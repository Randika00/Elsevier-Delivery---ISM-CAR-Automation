...
try:
    ...
    for line in url_details:
        try:
            ...
            base_url = "https://www.mtkxjs.com.cn/"
            toc_url = "https://www.mtkxjs.com.cn/en/article/current"

            current_datetime = datetime.now()
            current_date = str(current_datetime.date())
            current_time = current_datetime.strftime("%H:%M:%S")

            ini_path = os.path.join(os.getcwd(), "Ref_1404.ini")
                    ...
                    try:
                        ...
                        if article_title_div:
                            ...
                            if pages_doi_tag:
                                ...
                                pdf_url = f"https://www.mtkxjs.com.cn/article/exportPdf?id={id_values_string}&language=en"
