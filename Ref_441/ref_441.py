...
try:
    ...
    for line in url_details:
        try:
            ...
            base_url = "https://bbr.nefu.edu.cn/EN"
            toc_url = "https://bbr.nefu.edu.cn/EN/1673-5102/current.shtml"

            current_datetime = datetime.now()
            current_date = str(current_datetime.date())
            current_time = current_datetime.strftime("%H:%M:%S")

            ini_path = os.path.join(os.getcwd(), "Ref_441.ini")
            ...
            current_link = BeautifulSoup(response.content, "html.parser").find("div", class_="zxqk border border-radius").findAll("li")[0].find("a").get("href")
                    ...
                    try:
                        ...
                        if article_title_div:
                            ...
                            if page_ranges_doi_tag:
                                ...
                                doi_match = re.search(r'(doi:\d+\.\d+/j\.issn\.\d+-\d+\.\d+\.\d+\.\d+)',
                                                      page_ranges_doi_text)
                                if doi_match:
                                    doi = doi_match.group(1).replace("doi:", "") if doi_match else ""
                                ...
                                if date_volume_issue_info:
                                    ...
                                    for link in pdf_links:
                                        ...
                                        if pdf_id_match:
                                            ...
                                            base_pdf_url = "https://bbr.nefu.edu.cn/EN/article/downloadArticleFile.do?attachType=PDF&id="
