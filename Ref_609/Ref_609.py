...
try:
    ...
    for line in url_details:
        try:
            ...
            base_url = "https://www.rjhas.ru/"
            toc_url = "https://www.rjhas.ru/jour/user/setLocale/en_US?source=%2Fjour%2Fissue%2Fcurrent"

            current_datetime = datetime.now()
            current_date = str(current_datetime.date())
            current_time = current_datetime.strftime("%H:%M:%S")

            ini_path = os.path.join(os.getcwd(), "Ref_609.ini")
            ...
            latest_issue_div = soup.find("div", id="issues").findAll("div", class_="archive")[0].find("div", id="issue")
            link = latest_issue_div.find("a")["href"]
            link_id = link.split('/')[-2]

            current_link = f"https://www.rjhas.ru/jour/user/setLocale/en_US?source=%2Fjour%2Fissue%2Fview%2F{link_id}%2FshowToc"
