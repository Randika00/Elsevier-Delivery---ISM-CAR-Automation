...
try:
    ...
    for line in url_details:
        try:
            ...
            ini_path = os.path.join(os.getcwd(), "Ref_288.ini")
            ...
            current_link = BeautifulSoup(response.content, "html.parser").find("div", class_="left_tab_zxqk").findAll("li")[1].find("a").get("href")
            ...
            if response.status_code == 200:
                ...
                div_element = soup.find("div", class_="c_nr").findAll("div", class_="noselectrow")
                    ...
                    try:
                        ...
                        if article_title_div:
                            ...
                            if page_ranges_doi_tag:
                                ...
                                date_volume_issue_info = soup.find("div", class_="nianjq")
                                ...
                                if date_volume_issue_info:
                                    ...
                                    if article_response.status_code == 200:
                                        ...
                                        onclick_attr = article_soup.find_all("a", class_="black-bg btn-menu")
                                        pdf_id = ""
                                        for tag in onclick_attr:
                                            ...
                                            base_pdf_url = "http://ytlx.whrsm.ac.cn/CN/article/downloadArticleFile.do?attachType=PDF&id="
