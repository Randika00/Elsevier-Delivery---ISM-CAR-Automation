...
try:
    ...
    for line in url_details:
        try:
            ...
            base_url = "https://www.qichegongcheng.com/EN"
            toc_url = "https://www.qichegongcheng.com/EN/1000-680X/current.shtml"

            current_datetime = datetime.now()
            current_date = str(current_datetime.date())
            current_time = current_datetime.strftime("%H:%M:%S")

            ini_path = os.path.join(os.getcwd(), "Ref_844.ini")
            ...
            current_link = BeautifulSoup(response.content, "html.parser").find("ul", class_="nav navbar-nav").findAll("ul", class_="dropdown-menu site-nav")[1].find("li").find("a").get("href")
                                ...
                                if date_volume_issue_info:
                                    ...
                                    for link in pdf_links:
                                        ...
                                        if pdf_id_match:
                                            ...
                                            base_pdf_url = "https://www.qichegongcheng.com/EN/article/downloadArticleFile.do?attachType=PDF&id="
