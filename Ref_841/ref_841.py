...
try:
    ...
    for line in url_details:
        try:
            ...
            base_url = "https://sysengi.cjoe.ac.cn/EN"
            toc_url = "https://sysengi.cjoe.ac.cn/EN/current"

            current_datetime = datetime.now()
            current_date = str(current_datetime.date())
            current_time = current_datetime.strftime("%H:%M:%S")

            ini_path = os.path.join(os.getcwd(), "Ref_841.ini")
            ...
            current_link = BeautifulSoup(response.content, "html.parser").find("div", class_="tab_zxqk border border-radius box1").findAll("li")[1].find("a").get("href")
                    ...
                    try:
                        ...
                        if article_title_div:
                            ...
                            if date_volume_issue_text:
                                ...
                                token = get_token("https://sysengi.cjoe.ac.cn/EN/home")
                                pdf_link = f"https://sysengi.cjoe.ac.cn/EN/PDF/{doi}?token={token}"
