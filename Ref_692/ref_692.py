...
try:
    ...
    for line in url_details:
        try:
            ...
            base_url = "http://www.linyekexue.net/EN"
            toc_url = "http://www.linyekexue.net/EN/1001-7488/current.shtml"

            current_datetime = datetime.now()
            current_date = str(current_datetime.date())
            current_time = current_datetime.strftime("%H:%M:%S")

            ini_path = os.path.join(os.getcwd(), "Ref_692.ini")
            ...
            current_link = BeautifulSoup(response.content, "html.parser").find("div", class_="xw_tab").findAll("li")[0].find("a", string="Current Issue").get("href")
            ...
            if response.status_code == 200:
                ...
                div_element = soup.find("div", class_="articles margin20").findAll("div", class_="wenzhang")
                ...
                for single_element in div_element:
                    ...
                    try:
                        ...
                        if article_title_div:
                            article_title = article_title_div.find("dd").find("a", class_="biaoti").text.strip()
                            article_link = article_title_div.find("dd").find("a", class_="biaoti").get('href')
                            ...
                            for link in pdf_links:
                                ...
                                if pdf_id_match:
                                    ...
                                    base_pdf_url = "http://www.linyekexue.net/EN/article/downloadArticleFile.do?attachType=PDF&id="
