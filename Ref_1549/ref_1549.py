...
try:
    ...
    for line in url_details:
        try:
            ...
            base_url = "https://www.jsczz.cn/EN"
            toc_url = "https://www.jsczz.cn/EN/1000-7423/current.shtml"
            ...
            current_link = BeautifulSoup(response.content, "html.parser").find("div", class_="left-sidebar").findAll("ul")[2].find("a", string="Current Issue").get("href")
                ...
                for single_element in div_element:
                    ...
                    try:
                        ...
                        if article_title_div:
                            ...
                            token = get_token("https://www.jsczz.cn//")
                            pdf_link = f"https://www.jsczz.cn/EN/PDF/{doi}?token={token}"
