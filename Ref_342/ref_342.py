...
try:
    ...
    for line in url_details:
        try:
            ...
            base_url = "https://www.monaldi-archives.org"

            current_datetime = datetime.now()
            current_date = str(current_datetime.date())
            current_time = current_datetime.strftime("%H:%M:%S")

            ini_path = os.path.join(os.getcwd(), "Ref_342.ini")
                ...
                for single_element in div_element:
                    ...
                    try:
                        ...
                        if article_title_div:
                            ...
                            volume_issue_year_info = soup.find("div", class_="issue_cov").find("h1")
                            volume, issue, year = "", "", ""
                            ...
                            last_page_link = ""
                            if pdf_link_text:
                                last_page_link = pdf_link_text.find("a", class_="obj_galley_link pdf").get('href')
