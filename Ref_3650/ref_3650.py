...
try:
    ...
    for line in url_details:
        try:
            ...
            base_url = "https://www.yskw.ac.cn/"
            toc_url = "https://www.yskw.ac.cn/yskwxzzen/home"

            current_datetime = datetime.now()
            current_date = str(current_datetime.date())
            current_time = current_datetime.strftime("%H:%M:%S")

            ini_path = os.path.join(os.getcwd(), "Ref_3650.ini")
            ...
            if response.status_code == 200:
                ...
                try:
                    ...
                    try:
                        url_cn = toc_url.replace('/yskwxzzen', '/yskwxzz')
