...
try:
    ...
    for line in url_details:
        try:
            ...
            base_url = "https://journals.upress.ufl.edu/"
            ...
            current_link = BeautifulSoup(response.content, "html.parser").find("ul", class_="nav navbar-nav", id="main-navigation").find("li").find("a").get("href")
                    ...
                    try:
                        ...
                        if article_title_div:
                            ...
                            if article_links:
                                ...
                                subtitle_span = article_links.find("small")
                                if subtitle_span:
                            ...
                            volume_issue_year_info = soup.find("nav", class_="cmp_breadcrumbs").find("li", class_="active")
                            volume, issue, year = "", "", ""
                            ...
                            month_text = soup.find("div", class_="issue-details col-md-12").find("p", class_="published")
                            month = ""
                            if month_text:
                            ...
                            last_page_link = ""
                            if pages_text:
                                last_page_link = pdf_link_text.find("a", class_="galley-link btn btn-primary pdf", role="button").get('href')
