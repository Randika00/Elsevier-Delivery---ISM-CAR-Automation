...
try:
    ...
    for line in url_details:
        try:
            ...
            ini_path = os.path.join(os.getcwd(), "Ref_217_01.ini")
            ...
            current_link = f"https://revistaseug.ugr.es/index.php/acfs/user/setLocale/en_US?source=%2Findex.php%2Facfs%2Fissue%2Fview%2F{link_id}"
            ...
            if response.status_code == 200:
                ...
                for single_element in div_elements:
                    ...
                    try:
                        ...
                        subtitle_span = article_url.find("span", class_="subtitle")
                        if subtitle_span:
                            subtitle_text = subtitle_span.get_text(separator=" ", strip=True)
                            article_title = article_title.replace(subtitle_text, '').strip()
                        ...
                        if article_link_div:
                            ...
                            volume_match = re.search(r'Vol\.\s*(\d+)', volume_year_info)
                            year_match = re.search(r'\((\d{4})\)', volume_year_info)
