...
try:
    ...
    for line in url_details:
        try:
            ...
            toc_url = "https://riviste.unimi.it/index.php/enthymema/user/setLocale/en_US?source=%2Findex.php%2Fenthymema%2Fissue%2Farchive"

            current_datetime = datetime.now()
            current_date = str(current_datetime.date())
            current_time = current_datetime.strftime("%H:%M:%S")

            ini_path = os.path.join(os.getcwd(), "Ref_310_1.ini")
            ...
            current_link = BeautifulSoup(response.content, "html.parser").find("ul", id="navigationPrimary", class_="pkp_navigation_primary pkp_nav_list").find("li").find("a").get('href')
                        ...
                        if article_title_div:
                            ...
                            if a_tag:
                                ...
                                if volume_year_info:
                                    ...
                                    match = re.search(r'N\.\s*(\d+)\s*\((\d{4})\)', volume_year_text)
                                    if match:
