...
try:
    ...
    for line in url_details:
        try:
            ...
            base_url = "https://www.confiniacephalalgica.com"

            current_datetime = datetime.now()
            current_date = str(current_datetime.date())
            current_time = current_datetime.strftime("%H:%M:%S")

            ini_path = os.path.join(os.getcwd(), "Ref_308.ini")
                    ...
                    try:
                        ...
                        if article_title_div:
                            ...
                            if volume_issue_year_info:
                                ...
                                match = re.search(r'Vol\. (\d+) No\. (\d+) \((\d{4})\)', volume_issue_year_info.text.strip())
                                ...
                                if match:
                                    ...
                                    print("Could not extract volume, issue, and year.")
                            ...
                            if month_text:
                                ...
                                if published_date_text:
                                    date_match = re.search(r'(\d{2}-\d{2}-\d{4})', published_date_text)
                                    if date_match:
