...
try:
    ...
    uc_soup = BeautifulSoup(response.content, 'html.parser')
    current_issue_link="https://research.aota.org"+uc_soup.find("div",class_="view-current-issue").find("a").get("href")
    ...
    while i < len(All_articles):
        ...
        try:
            ...
            if not Article_link in read_content:
                ...
                pdf_link="https://research.aota.org"+article_soup.find("li",class_="toolbar-item item-with-dropdown item-pdf").find("a").get("href")
