...
try:
    ...
    for line in url_details:
        try:
            ...
            base_url = "http://www.kyaqyhb.com"
            toc_url = "http://www.kyaqyhb.com/en/article/current"

            current_datetime = datetime.now()
            current_date = str(current_datetime.date())
            current_time = current_datetime.strftime("%H:%M:%S")

            ini_path = os.path.join(os.getcwd(), "Ref_3774.ini")
                    ...
                    try:
                        ...
                        if article_title_div:
                            ...
                            if pages_doi_tag:
                                ...
                                pdf_url = f"http://www.kyaqyhb.com/article/exportPdf?id={id_values_string}&language=en"
