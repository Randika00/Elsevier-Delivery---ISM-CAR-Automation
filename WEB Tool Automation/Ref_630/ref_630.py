...
try:
    ...
    for line in url_details:
        try:
            ...
            base_url = "https://www.cadernosdeterapiaocupacional.ufscar.br/"
            toc_url = "https://www.cadernosdeterapiaocupacional.ufscar.br/index.php/cadernos//user/setLocale/en_US?source=%2Findex.php%2Fcadernos%2Fissue%2Fcurrent"

            current_datetime = datetime.now()
            current_date = str(current_datetime.date())
            current_time = current_datetime.strftime("%H:%M:%S")

            ini_path = os.path.join(os.getcwd(), "Ref_630.ini")
            ...
            link = soup.find("ul", class_="issues_archive").find("div", class_="obj_issue_summary")

            link_link = link.find("a", class_="cover")["href"]
            link_id = link_link.split('/')[-1]

            current_link = f"https://www.cadernosdeterapiaocupacional.ufscar.br/index.php/cadernos/user/setLocale/en_US?source=%2Findex.php%2Fcadernos%2Fissue%2Fview%2F{link_id}"

            title_text = link.find("a", class_="title").text.strip()
            volume = title_text.split("Vol.")[1].split("(")[0].strip()
            year = title_text.split("(")[1].split(")")[0].strip()
                ...
                for single_element in div_element:
                    ...
                    try:
                        ...
                        if article_title_div:
                            ...
                            identifier = ""
                            if pages_text:
                                identifier = pages_text.text.strip() if pages_text else ""
