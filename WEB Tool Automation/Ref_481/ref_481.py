...
try:
    ...
    for line in url_details:
        try:
            ...
            base_url = "https://www.voplit.com/"
            toc_url = "https://www.voplit.com/jour/user/setLocale/en_US?source=%2Fjour%2Fissue%2Fcurrent"

            current_datetime = datetime.now()
            current_date = str(current_datetime.date())
            current_time = current_datetime.strftime("%H:%M:%S")

            ini_path = os.path.join(os.getcwd(), "Ref_481.ini")
            ...
            div_archive = soup.find("div", class_="archive")
            latest_issue = div_archive.find_all("div", id="issue")[-1]

            link = latest_issue.find("a")["href"]
            link_id = link.split('/')[-2]
            current_link = f"https://www.voplit.com/jour/user/setLocale/en_US?source=%2Fjour%2Fissue%2Fview%2F{link_id}%2FshowToc"

            issue_text = latest_issue.find("h4").text
            issue = issue_text.split("No ")[1].split(" (")[0]
            year = issue_text.split(" (")[1].strip(")")
