...
try:
    ...
    for line in url_details:
        try:
            ...
            base_url = "https://journal.nephrolog.ru"
            toc_url = "https://journal.nephrolog.ru/jour/user/setLocale/en_US?source=%2Fjour%2Fissue%2Fcurrent"

            current_datetime = datetime.now()
            current_date = str(current_datetime.date())
            current_time = current_datetime.strftime("%H:%M:%S")

            ini_path = os.path.join(os.getcwd(), "Ref_516.ini")
            ...
            for issue in issues:
                ...
                if match:
                    ...
                    issue_number = int(match.group(2)) if match else ""
                    year = int(match.group(3)) if match else ""

                    if (volume > latest_volume) or (volume == latest_volume and issue_number > latest_issue_number):
            ...
            current_link = f"https://journal.nephrolog.ru/jour/user/setLocale/en_US?source=%2Fjour%2Fissue%2Fview%2F{link_id}%2FshowToc"
                ...
                for single_element in div_element:
                    ...
                    try:
                        ...
                        if article_title_div:
                            ...
                            pdf_link = last_page_link.replace('/view', '/download')
