...
try:
    ...
    for line in url_details:
        try:
            ...
            base_url = "https://lxxb.cstam.org.cn"
            toc_url = "https://lxxb.cstam.org.cn/en/article/current"

            current_datetime = datetime.now()
            current_date = str(current_datetime.date())
            current_time = current_datetime.strftime("%H:%M:%S")

            ini_path = os.path.join(os.getcwd(), "Ref_581.ini")
            ...
            link = BeautifulSoup(response.content, "html.parser").find("ul", class_="nav-inner clearfix container").find("li", attrs={"type": "currentIssue_en"}).find("a").get("href")
                    ...
                    try:
                        ...
                        if article_title_div:
                            ...
                            if match:
                                ...
                                month = ""
                                if issue in issue_to_month:
                                    month = issue_to_month[issue]
                                else:
                                    print(f"Unknown issue number: {issue}")
                                ...
                                pdf_url = f"https://lxxb.cstam.org.cn/article/exportPdf?id={id_values_string}&language=en"
