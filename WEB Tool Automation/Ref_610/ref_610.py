...
try:
    ...
    for line in url_details:
        try:
            ...
            toc_url = "https://www.chebsbornik.ru/jour/user/setLocale/en_US?source=%2Fjour%2Fissue%2Fcurrent"

            current_datetime = datetime.now()
            current_date = str(current_datetime.date())
            current_time = current_datetime.strftime("%H:%M:%S")

            ini_path = os.path.join(os.getcwd(), "Ref_610.ini")
            ...
            latest_issue = soup.find("div", id="issues").find("div", id="issue")

            link_tag = latest_issue.find("h4").find("a")
            link = link_tag["href"]
            link_id = link.split('/')[-1]

            current_link = f"https://www.chebsbornik.ru/jour/user/setLocale/en_US?source=%2Fjour%2Fissue%2Fview%2F{link_id}"

            issue_text = link_tag.text
            volume = issue_text.split(",")[0].split(" ")[1]
            issue = issue_text.split(",")[1].split(" ")[2]
                    ...
                    try:
                        ...
                        if article_title_div:
                            ...
                            if pages_tag:
                                ...
                                print("Page Range tag not found.")
