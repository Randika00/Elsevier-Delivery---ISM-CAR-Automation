...
try:
    ...
    for line in url_details:
        try:
            ...
            base_url = "http://hjxb.hwi.com.cn"
            toc_url = "http://hjxb.hwi.com.cn/hjxb/en/article/current"

            current_datetime = datetime.now()
            current_date = str(current_datetime.date())
            current_time = current_datetime.strftime("%H:%M:%S")

            ini_path = os.path.join(os.getcwd(), "Ref_686.ini")
            ...
            link = BeautifulSoup(response.content, "html.parser").find("ul", class_="nav-inner clearfix container").find("li", type="currentissue").find("a", string="Current Issue").get("href")
                    ...
                    try:
                        ...
                        if article_title_div:
                            ...
                            if pages_doi_tag:
                                ...
                                doi = pages_doi_tag.find("a").get("href").replace("/hjxb/en/article/doi/", "") if pages_doi_tag else ""
                            else:
                            ...
                            pdf_link = f"http://hjxb.hwi.com.cn/hjxb/article/exportPdf?id={id_values_string}&language=en"
