...
try:
    ...
    for line in url_details:
        try:
            ...
            base_url = "https://iej.zaslavsky.com.ua/"
            toc_url = "https://iej.zaslavsky.com.ua/index.php/journal/user/setLocale/en_US?source=%2Findex.php%2Fjournal%2Fissue%2Fcurrent"

            current_datetime = datetime.now()
            current_date = str(current_datetime.date())
            current_time = current_datetime.strftime("%H:%M:%S")

            ini_path = os.path.join(os.getcwd(), "Ref_380.ini")
            ...
            link_text = link.find("a", class_="title")["href"]
            link_id = link_text.split('/')[-1]

            current_link = f"https://iej.zaslavsky.com.ua/index.php/journal/user/setLocale/en_US?source=%2Findex.php%2Fjournal%2Fissue%2Fview%2F{link_id}"

            title_text = link.find("a", class_="title").text.strip()

            volume = title_text.split("Vol. ")[1].split(" No. ")[0].strip()
            issue = title_text.split("No. ")[1].split(" (")[0].strip()
