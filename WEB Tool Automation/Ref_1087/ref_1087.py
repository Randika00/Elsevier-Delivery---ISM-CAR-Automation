...
try:
    ...
    for line in url_details:
        try:
            ...
            base_url = "http://cje.ustb.edu.cn"
            toc_url = "http://cje.ustb.edu.cn/en/article/current"

            current_datetime = datetime.now()
            current_date = str(current_datetime.date())
            current_time = current_datetime.strftime("%H:%M:%S")

            ini_path = os.path.join(os.getcwd(), "Ref_1087.ini")
            ...
            link = BeautifulSoup(response.content, "html.parser").find("ul", class_="nav-inner clearfix container").find("li", attrs={"type": "currentissue_en"}).find("a", string="Latest Issue").get("href")
                ...
                for single_element in div_element:
                    ...
                    try:
                        ...
                        if article_title_div:
                            ...
                            pdf_url = f"http://cje.ustb.edu.cn/article/exportPdf?id={id_values_string}&language=en"
