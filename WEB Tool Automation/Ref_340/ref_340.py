...
try:
    ...
    for line in url_details:
        try:
            ...
            base_url = "http://www.cgejournal.com"
            toc_url = "http://www.cgejournal.com/en/article/current"

            current_datetime = datetime.now()
            current_date = str(current_datetime.date())
            current_time = current_datetime.strftime("%H:%M:%S")

            ini_path = os.path.join(os.getcwd(), "Ref_340.ini")
                ...
                for single_element in div_element:
                    ...
                    try:
                        ...
                        if article_title_div:
                            ...
                            pdf_url = f"http://www.cgejournal.com/article/exportPdf?id={id_values_string}&language=en"
