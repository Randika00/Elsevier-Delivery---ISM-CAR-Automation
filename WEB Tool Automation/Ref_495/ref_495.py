...
try:
    ...
    for line in url_details:
        try:
            ...
            base_url = "https://www.mtxb.com.cn"
            toc_url = "https://www.mtxb.com.cn/en/article/current"

            current_datetime = datetime.now()
            current_date = str(current_datetime.date())
            current_time = current_datetime.strftime("%H:%M:%S")

            ini_path = os.path.join(os.getcwd(), "Ref_495.ini")
            ...
            link = BeautifulSoup(response.content, "html.parser").find("ul", class_="nav-inner clearfix").find("li", attrs={"type": "currentIssue_en"}).find("a", string="Current Issue").get("href")
                    ...
                    try:
                        ...
                        if article_title_div:
                            ...
                            if pages_doi_tag:
                                ...
                                pdf_url = f"https://www.mtxb.com.cn/article/exportPdf?id={id_values_string}&language=en"
