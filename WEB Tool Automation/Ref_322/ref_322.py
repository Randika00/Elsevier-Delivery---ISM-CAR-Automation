...
try:
    ...
    for line in url_details:
        try:
            ...
            base_url = "https://agrolifejournal.usamv.ro/"

            current_datetime = datetime.now()
            current_date = str(current_datetime.date())
            current_time = current_datetime.strftime("%H:%M:%S")

            ini_path = os.path.join(os.getcwd(), "Ref_322.ini")
                ...
                for single_element in div_element:
                    ...
                    try:
                        ...
                        if article_title_div:
                            ...
                            doi_tag = single_element.find("div", class_="doi", style="font-weight:bold")
                            doi = ""
                            if doi_tag:
                            ...
                            volume_issue_year_info = soup.find("ol", class_="breadcrumb").find("li", class_="active")
                            volume, issue, year = "", "", ""
                            ...
                            month_text = soup.find("div", class_="issue-details col-md-8").find("p", class_="published")
                            month = ""
                            if month_text:
