...
try:
    ...
    for line in url_details:
        try:
            ...
            base_url = "http://jogg.cug.edu.cn"
            toc_url = "http://jogg.cug.edu.cn/en/article/current"

            current_datetime = datetime.now()
            current_date = str(current_datetime.date())
            current_time = current_datetime.strftime("%H:%M:%S")

            ini_path = os.path.join(os.getcwd(), "Ref_419.ini")
            ...
            link = BeautifulSoup(response.content, "html.parser").find("ul", class_="nav-inner clearfix container").find("li", attrs={"type": "currentIssue_en"}).find("a", string="Current Issue").get("href")
                ...
                for single_element in div_element:
                    ...
                    try:
                        ...
                        if article_title_div:
                            ...
                            pdf_url = f"http://jogg.cug.edu.cn/article/exportPdf?id={id_values_string}&language=en"
