...
while url_index < len(url_list):
    try:
        ...
        if url_check == 0:
            print(url_id)
            ini_path = os.path.join(os.getcwd(), "REF_287.ini")
        ...
        en_href = soup.find('div', class_='language').find('a', class_='en').get('data')
        print(en_href)
        ...
        year_text=en_soup.find("div", class_="tocArticle flex").find("div", class_="title").text.strip()
        ...
        All_articles = en_soup.find_all('div',class_='issueArticle flex')
        ...
        while article_index < len(All_articles):
            ...
            try:
                ...
                page_range=All_articles[article_index].find("div",class_="date-row").find("span",class_="pages grey").text.strip()
                ...
                try:
                    pdf_link_href = pdf_page_soup.find("a", class_="file PDF ru_RU PDF (Rus)").get('href')
