...
for url_info in url_info_list:
    try:
        ...
        ini_path= os.path.join(os.getcwd(),"REF_175.ini")
        ...
        content_archive = soup.find_all('div',class_="flex-row flex-justify-btw flex-align-start")
        ...
        for element in content_archive:
            Article_link=None
            try:
                Article_link="https://thejns.org"+element.find("a").get('href')
