...
while url_index < len(url_list):
    try:
        ...
        if url_check == 0:
            ...
            ini_path = os.path.join(os.getcwd(), "REF_1596.ini")
        ...
        date_time_meta=soup.find("div",class_="issue_sidebar_widget").find("strong").get_text(strip=True)
        try:
        ...
        All_articles =soup.find_all("div",class_="post_meta")
        ...
        while article_index < len(All_articles):
            ...
            try:
                ...
                try:
                    pdf_link = soup_2.find("a", class_="sitemap", string="Download article").get("href")
